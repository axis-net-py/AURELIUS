...
const translations = {
  pt: {
    ...
    newMemberDesc: "Insira os dados do novo membro para liberar o acesso ao sistema. A senha inicial padrão será 'AxisFarm123!'.",
    save: "Cadastrar",
    cancel: "Cancelar",
  ...
  es: {
    ...
    newMemberDesc: "Ingrese los datos del nuevo miembro para habilitar su acceso. La contraseña inicial por defecto será 'AxisFarm123!'.",
    save: "Registrar",
    cancel: "Cancelar",
